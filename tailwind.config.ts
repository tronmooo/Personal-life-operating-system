  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'radial-gradient(at 40% 20%, hsla(262, 83%, 58%, 0.15) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(186, 94%, 42%, 0.1) 0px, transparent 50%)',
      },
      keyframes: {
        'accordion-down': {
          from: { height: '0' },
        ...
        'glow-pulse': {
          ...
          '50%': { boxShadow: '0 0 15px hsl(var(--primary) / 0.4), 0 0 30px hsl(var(--primary) / 0.2)' },
        },
        'float': {
