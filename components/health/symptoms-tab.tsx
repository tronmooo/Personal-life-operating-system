        ...
        <CardContent className="space-y-4">
          {symptomEntries.length === 0 ? (
            ...
            symptomEntries.map(entry => {
              ...
              const severity = Number(metadata.severity) || 5
              const duration = String(metadata.duration || '2 hours')
              const mood = String(metadata.mood || 'Fair')
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <p className="text-sm text-gray-500">
                            {format(new Date(entry.createdAt), 'MM/dd/yyyy')} at {format(new Date(entry.createdAt), 'h:mm a')}
                          </p>
                        </div>
                      </div>
                    </div>
