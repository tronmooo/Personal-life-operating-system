...
interface Utility {
  ...
  amount: number
  dueDate: string
  frequency: 'monthly' | 'weekly' | 'daily' | 'quarterly' | 'annually'
  usage: string
  status: 'paid' | 'unpaid'
...
interface EditUtilityDialogProps {
  ...
  utility: Utility
  onSave: (utility: Utility) => void
}

export function EditUtilityDialog({ open, onOpenChange, utility, onSave }: EditUtilityDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl">Edit Utility</DialogTitle>
        </DialogHeader>
