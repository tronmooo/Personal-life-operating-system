            ...
            <Card className="p-12 text-center bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm">
              <div className="max-w-md mx-auto">
                <div className="w-16 h-16 rounded-full bg-amber-100 dark:bg-amber-900/20 flex items-center justify-center mx-auto mb-4">
                  <HomeIcon className="h-8 w-8 text-amber-600 dark:text-amber-500" />
                </div>
                <h3 className="text-xl font-bold mb-2">No Properties Yet</h3>
                <p className="text-muted-foreground mb-6">
                  You haven&apos;t added any properties yet. Add your first property to start tracking bills, maintenance, and assets for your home.
                </p>
                <div className="bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mb-6">
                  <p className="text-sm text-amber-800 dark:text-amber-200 font-medium mb-1">
                    💡 Need to track utility bills?
                  </p>
                  <p className="text-xs text-amber-700 dark:text-amber-300">
                    Bills like electricity, water, and internet are tied to specific properties. Add a property first, then manage bills from its detail page.
                  </p>
                </div>
                <Button 
                  onClick={() => setShowAddDialog(true)}
